...
export default {
    ...
    data() {
        return {
            accountArr: [
                { user: '', tip: '面板账户', icon: 'el-icon-user', button: '修改', click: 'panelAccount' },
                { user: '', tip: '宝塔账号', icon: 'bt', i: true, button: '绑定', click: 'btAccount'},
                { user: '', tip: '微信小程序', icon: 'el-icon-connection', button: '绑定', click: 'wechatApp'},
                { user: '', tip: 'BasicAuth', icon: 'auth', i: true, button: '配置', click: 'basicAuth'}
            ]
        }
    },
    watch: {
    ...
    computed: {
        ...
        ...mapGetters('thisConfig', ['IsPanelAccount', 'IsBtAccount', 'IsWechatApp', 'IsBasicAuth'])
    }
}
</script>
